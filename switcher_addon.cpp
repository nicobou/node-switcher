...
static switcher::QuiddityManager::ptr switcher_manager;
...
v8::Handle<v8::Value> SetProperty(const v8::Arguments& args) {
  ...
  v8::Handle<v8::Boolean> res = v8::Boolean::New(switcher_manager->set_property(std::string(*element_name), std::string(*property_name), std::string(*property_val)));
  return scope.Close(res);
}
...
v8::Handle<v8::Value> Test(const v8::Arguments& args) {
  ...
  GstElement *fakesrc = gst_element_factory_make ("videotestsrc",NULL);
  ...
  v8::Local<v8::String> name = v8::String::New("test");
  //v8::Local<v8::String> name = v8::String::New("truc");
  return scope.Close(name);
}
...
void Init(v8::Handle<v8::Object> target) {
  ...
  switcher_manager = switcher::QuiddityManager::make_manager ("nodeserver");  
